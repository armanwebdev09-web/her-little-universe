  ...
  return (
    <section className="relative pt-32 pb-16 px-6 z-10 text-center flex flex-col items-center justify-center">
      ...
      <div className="max-w-4xl mx-auto flex flex-col items-center">
        ...
        >
          <Camera className="w-3.5 h-3.5 text-[#D8B477]" />
        ...
        >
          ...
          <span className="italic font-light text-[#D9A6B2]">Forever memories.</span>
        </motion.h1>
        ...
        <motion.p
          ...
          className="text-base sm:text-xl text-[#B8B6C4] font-light max-w-xl leading-relaxed"
        >
          Some moments are too beautiful to leave in the past.
        </motion.p>
      </div>
    </section>
  );
